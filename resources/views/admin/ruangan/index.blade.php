            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="{{ route('admin.ruangan.destroy', $item->id) }}" class="inline delete-form">@csrf @method('DELETE')
                                <button class="btn btn-danger btn-sm !px-2" data-tippy-content="Hapus Ruangan">🗑️</button>
                            </form>
                        </td>
                    </tr>
                    @empty
